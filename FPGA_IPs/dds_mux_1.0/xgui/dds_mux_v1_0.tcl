...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_NMR_PULSE_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_S01_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox


}

proc update_PARAM_VALUE.C_NMR_PULSE_DATA_WIDTH { PARAM_VALUE.C_NMR_PULSE_DATA_WIDTH } {
	# Procedure called to update C_NMR_PULSE_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_NMR_PULSE_DATA_WIDTH { PARAM_VALUE.C_NMR_PULSE_DATA_WIDTH } {
	# Procedure called to validate C_NMR_PULSE_DATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_NMR_PULSE_DATA_WIDTH { MODELPARAM_VALUE.C_NMR_PULSE_DATA_WIDTH PARAM_VALUE.C_NMR_PULSE_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_NMR_PULSE_DATA_WIDTH}] ${MODELPARAM_VALUE.C_NMR_PULSE_DATA_WIDTH}
}
